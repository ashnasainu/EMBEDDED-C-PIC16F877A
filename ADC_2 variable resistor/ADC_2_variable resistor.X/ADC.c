...
{
    ADCON0 = 0x41;
    ADCON1 = 0x85;     // enables A0 &A1 as analog pins
    ...
    ADCON1bits.PCFG0=1; ADCON1bits.PCFG1=0; ADCON1bits.PCFG2=1; ADCON1bits.PCFG3=1;   // Port configuration (setting A0 & A1 as analog pin)
...
int ADC_read(int a)
{
    ...
    {
        ADCON0bits.CHS0=1;                                       // Reading portion of ADC
        ADCON0bits.CHS1=0;                                       // selecting channel 1 (AN1)
        ADCON0bits.CHS2=0;  
    }
